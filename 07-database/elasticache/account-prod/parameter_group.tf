...
resource "aws_elasticache_parameter_group" "account_redis_cluster_pg" {
  name        = "account-cluster-${data.terraform_remote_state.vpc.outputs.shard_id}"
  description = "Account Elasticache Redis Parameter Group"
