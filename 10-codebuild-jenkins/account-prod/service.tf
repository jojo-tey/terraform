...
module "hello" {
  ...
  # e.g) hello.account-prodops.com
  domain_name = "hello"

  # Route53 variables
  acm_external_ssl_certificate_arn = var.r53_variables.prod.star_account-prodops_com_acm_arn_apnortheast2
  route53_external_zone_id         = var.r53_variables.prod.account-prodops_com_zone_id
